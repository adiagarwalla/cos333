# Django settings for qurious project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'Qurious.db',                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = '/var/html/cos333/qurious_backend/qurious/'
...
SECRET_KEY = '+(ql&ypa$&5=qc*r%3p7e*4ud@vp#uot1i8gk3(6k$_lnh0=5i'
...
ROOT_URLCONF = 'qurious.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'qurious.wsgi.application'
